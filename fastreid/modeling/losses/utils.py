...
def cosine_sim(x, y):
    ...
    frac_up = mindspore.ops.matmul(x, y.swapaxes(0, 1))
    # frac_up = torch.matmul(x, y.transpose(0, 1))
    # print("bs1, bs2", bs1, bs2)
    # print("x, y", x.shape, y.shape)
    # print("x", mindspore.ops.sqrt(mindspore.ops.sum(mindspore.ops.pow(x, 2), 1)).shape)
    # print("y", mindspore.ops.sqrt(mindspore.ops.sum(mindspore.ops.pow(y, 2), 1)).shape)
